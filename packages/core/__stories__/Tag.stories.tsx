...
export const Main: Story = {
  render: () => (
    <>
      ...
      <NuiTag color="teal">Sample4</NuiTag>
    </>
  ),
};
...
export const Semantic: Story = {
  render: () => (
    <>
      <NuiTag color="success" variant="semantic">
        Sample 1
      </NuiTag>
      <NuiTag color="error" variant="semantic">
        Sample 2
      </NuiTag>
      <NuiTag color="warning" variant="semantic">
        Sample 3
      </NuiTag>
      <NuiTag color="neutral" variant="semantic">
        Sample 4
      </NuiTag>
    </>
  ),
